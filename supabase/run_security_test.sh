...
for f in schema.sql storage.sql mt5.sql phase0.sql phase3.sql phase4.sql phase5.sql phase6.sql phase7.sql phase8.sql phase9.sql funded.sql tags.sql comparison.sql; do
  printf '  %-14s' "$f"
